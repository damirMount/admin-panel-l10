    ...
    <div class="p-3 bg-form card-body-admin">
        <div class="row">
            <div class="col-12 col-sm-10 col-lg-12 col-md-10 pb-5 px-5">
                <form action="{{ route('admin_articles.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input id="killed_input" type="number" class="form-control" name="killed" required value="{{old('killed')}}">
                    </div>
                    <div class="form-group">
                        <label for="arrested_input">Арестован:<span class="text-danger">*</span></label>
                        <input id="arrested_input" type="number" class="form-control" name="arrested" required value="{{old('arrested')}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="date_input" type="datetime-local" class="form-control" name="date" required value="{{old('date')}}">
                    </div>
                    <div class="form-group">
                        <label for="meta_title_input">Мета название:</label>
                        <input id="meta_title_input" type="text" class="form-control" name="meta_title" value="{{old('meta_title')}}">
                    </div>
                    <div class="form-group">
                        <label for="meta_keywords_input">Мета ключевые:</label>
                        <input id="meta_keywords_input" type="text" class="form-control" name="meta_keywords" value="{{old('meta_keywords')}}">
                    </div>
                    <div class="form-group">
